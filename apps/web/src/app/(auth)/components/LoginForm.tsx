      ...
      <CardContent className="space-y-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="space-y-2">
            ...
            {errors.email && (
              <p id="email-error" className="text-sm text-red-400 flex items-center space-x-1">
                <span>⚠</span>
          ...
          {magicMode ? (
            <div className="space-y-2">
              <p className="text-sm text-slate-300">We'll send a sign-in link to your email.</p>
              <div className="text-center">
                {magicSent ? (
                  <p className="text-sm text-green-400">Magic link sent — check your inbox.</p>
                ) : (
                  <div className="flex gap-2">
                    ...
                    <Button type="button" variant="ghost" onClick={() => setMagicMode(false)} className="h-12">Cancel</Button>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.password && (
                <p id="password-error" className="text-sm text-red-400 flex items-center space-x-1">
                  <span>⚠</span>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="text-sm text-blue-400 hover:text-blue-300 transition-colors duration-200"
                aria-label="Use magic link to sign in"
              >
                Use magic link
              </button>
            </div>
        ...
        <div className="space-y-3">
          <Button
            ...
            disabled={isSubmitting || loading}
          >
            <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24" role="img" aria-hidden="true">
