  ...
  try {
        ...
        sentiment: [
          {
            ...
            label: "Neutral",
            description:
              "Institutional data pulses active. AI sentiment waiting for configuration.",
          },
          {
            category: "Stocks",
            score: 50,
            label: "Neutral",
            description:
              "Monitoring equity flow via historical volatility patterns.",
          },
          {
            category: "Forex",
            score: 50,
            label: "Neutral",
            description:
              "Currency pairs tracking institutional liquidity zones.",
          },
        ],
      });
    }
    ...
    if (error.response) {
      console.error(
        ...
        (await error.response.text?.()) || error.response,
      );
    }
    return Response.json({
      sentiment: [
        {
          ...
          score: 50,
          label: "Neutral",
          description: "Monitoring market stability.",
        },
        {
          category: "Stocks",
          score: 50,
          label: "Neutral",
          description: "Awaiting direction.",
        },
        {
          category: "Forex",
          score: 50,
          label: "Neutral",
          description: "Range-bound trading observed.",
        },
      ],
    });
  }
