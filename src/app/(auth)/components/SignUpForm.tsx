  ...
  return (
    <Card className="w-full border-slate-700/50 bg-slate-800/50 backdrop-blur-xl shadow-2xl">
      <CardHeader className="space-y-3 text-center">
        <div className="mx-auto h-12 w-12 rounded-xl bg-gradient-to-r from-teal-500 to-blue-500 flex items-center justify-center">
          <UserPlus className="h-6 w-6 text-white" />
        </div>
        <CardTitle className="text-3xl font-bold text-white">Join Trade Pulse</CardTitle>
        <CardDescription className="text-slate-300">
          Create your account to start trading with intelligent insights
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="space-y-2">
            <Label htmlFor="displayName" className="text-slate-200 font-medium">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 h-12 bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-400 focus:border-teal-500 focus:ring-teal-500/20 transition-all duration-200 ${
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                {...register('password')}
                className={`pl-10 pr-12 h-12 bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-400 focus:border-teal-500 focus:ring-teal-500/20 transition-all duration-200 ${
          ...
          <div className="flex items-start space-x-2">
            <input
              ...
              type="checkbox"
              required
              className="mt-1 h-4 w-4 rounded border-slate-600 bg-slate-700 text-teal-500 focus:ring-teal-500/20"
