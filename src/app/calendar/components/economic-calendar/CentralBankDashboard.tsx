  ...
  return (
    <div className="bg-card/40 rounded-xl p-4 md:p-6 border border-border/40 shadow-sm space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Badge variant="outline" className="h-5 text-[9px] font-mono border-primary/20 text-primary bg-primary/5 px-1.5">
          {events.length} NEXT
        </Badge>
      </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-bold text-foreground uppercase tracking-tight">{event.bank}</span>
                      <Badge variant="outline" className={cn("h-4 text-[8px] font-bold uppercase border-transparent bg-background/40", typeStyles.icon)}>
                        {event.type}
                      </Badge>
                    </div>
                    {event.speaker && (
