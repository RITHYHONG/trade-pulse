...
interface WatchlistSymbolErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function WatchlistSymbolError({ error, reset }: WatchlistSymbolErrorProps) {
  return (
    <div className="rounded-3xl border border-rose-500/30 bg-rose-500/10 p-6 text-rose-100">
      <h2 className="text-lg font-semibold">Instrument data unavailable</h2>
